...
from .utils import _extract_section_content, _parse_bold_headers, _validate_token, _find_pdfs, _read_pdf_core, _generate_mini_summary, _extract_title
...
@mcp.tool(
    name="extract_title",
    description=(
        "Extracts the paper's title"
    ),
    tags={"pdf", "section", "title"},
)
def extract_title(
    file_id: str,
) -> str:
    ...
    """
    return _extract_title(file_id=file_id)
